...
func TestParseCoder(t *testing.T) {
	tests := []struct {
		...
		{fmt.Errorf("yes error"), 500, "An internal server error occurred", 1, "http://github.com/leotons/errors/README.md"},
		{WithCode(unknownCoder.Code(), "internal error message"), 500, "An internal server error occurred", 1, "http://github.com/leotons/errors/README.md"},
	}
