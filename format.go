...
//      %-v:   error for internal read B - #0 [/home/lk/workspace/golang/src/github.com/leotons/iam/main.go:12 (main.main)] (#100102) Internal Server Error
//      %+v:   error for internal read B - #0 [/home/lk/workspace/golang/src/github.com/leotons/iam/main.go:12 (main.main)] (#100102) Internal Server Error; error for internal read A - #1 [/home/lk/workspace/golang/src/github.com/leotons/iam/main.go:35 (main.newErrorB)] (#100104) Validation failed
//      %#v:   [{"error":"error for internal read B"}]
//      %#-v:  [{"caller":"#0 /home/lk/workspace/golang/src/github.com/leotons/iam/main.go:12 (main.main)","error":"error for internal read B","message":"(#100102) Internal Server Error"}]
//      %#+v:  [{"caller":"#0 /home/lk/workspace/golang/src/github.com/leotons/iam/main.go:12 (main.main)","error":"error for internal read B","message":"(#100102) Internal Server Error"},{"caller":"#1 /home/lk/workspace/golang/src/github.com/leotons/iam/main.go:35 (main.newErrorB)","error":"error for internal read A","message":"(#100104) Validation failed"}]
